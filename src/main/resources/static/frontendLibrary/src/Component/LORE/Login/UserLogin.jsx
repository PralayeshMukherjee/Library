      ...
      <div className="w-80 p-6 bg-white/20 bg-opacity-20 backdrop-blur-md shadow-md rounded-lg border border-white">
        ...
        <form onSubmit={handelSubmit} className="flex flex-col space-y-4">
          <div>
            ...
            <input type="text" id="username" name="username" className="w-full p-2 bg-transparent border border-white text-white rounded-lg focus:outline-none placeholder-white" placeholder="Enter username" onChange={handelChange} />
          </div>
          <div>
