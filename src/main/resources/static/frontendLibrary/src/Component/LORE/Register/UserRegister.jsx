    ...
    <div className="bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center min-h-screen">
      <div className="bg-white/20 bg-opacity-20 backdrop-blur-lg rounded-xl shadow-lg p-8 w-full max-w-md">
        ...
        <form onSubmit={handelSubmit} className="space-y-4">
          ...
          <input name="name" type="text" placeholder="Full Name" onChange={handleChange} className="w-full mt-1 p-2 rounded-lg bg-white/20 bg-opacity-50 focus:outline-none" required />
          <label className="text-white block text-sm font-medium m-auto">Age</label>
          <input name="age" type="number" placeholder="Age" onChange={handleChange} className="w-full mt-1 p-2 rounded-lg bg-white/20 bg-opacity-50 focus:outline-none" required />
          <label className="text-white block text-sm font-medium m-auto">Phone Number</label>
          <input name="phoneNumber" type="tel" placeholder="Phone Number" onChange={handleChange} className="w-full mt-1 p-2 rounded-lg bg-white/20 bg-opacity-50 focus:outline-none" required />
          <label className="text-white block text-sm font-medium m-auto">Email ID</label>
          <input name="emailId" type="email" placeholder="Email ID" onChange={handleChange} className="w-full mt-1 p-2 rounded-lg bg-white/20 bg-opacity-50 focus:outline-none" required />
          <label className="text-white block text-sm font-medium m-auto">Gender</label>
          <select name="gender" onChange={handleChange} className="w-full mt-1 p-2 rounded-lg bg-white/20 bg-opacity-50 focus:outline-none" required>
